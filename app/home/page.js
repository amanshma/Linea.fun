...
//         <div>
//           <div className='text-green-600 font-semibold text-4xl'>Linea.fun</div>
//           <div className='text-neutral-400'>Find the best Linea.fun tokens and track latest migrations</div>
//         </div>
